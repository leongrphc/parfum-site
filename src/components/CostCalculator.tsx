    ...
    <Card className="bg-white/5 border-white/10 backdrop-blur-md">
       <CardHeader className="pb-2">
          <CardTitle className="flex items-center gap-2 text-sm text-green-400">
            <Coins className="w-4 h-4" /> Maliyet Hesaplayıcı (Birim)
          </CardTitle>
       </CardHeader>
       <CardContent className="space-y-3">
          <div className="grid grid-cols-2 gap-2">
             <div className="space-y-1">
                <Label className="text-[10px] text-muted-foreground">Esans (₺/gr)</Label>
                <Input 
                  type="number" 
             ...
             <div className="space-y-1">
                <Label className="text-[10px] text-muted-foreground">Alkol (₺/Litre)</Label>
                <Input 
                  type="number" 
                  className="h-7 text-xs bg-black/20 border-white/10" 
                  placeholder="0.00"
             ...
             <div className="space-y-1">
                <Label className="text-[10px] text-muted-foreground">Fixative (₺/ml)</Label>
                <Input 
                  type="number" 
                  className="h-7 text-xs bg-black/20 border-white/10" 
                  placeholder="0.00"
             ...
             <div className="space-y-1">
                <Label className="text-[10px] text-muted-foreground">Şişe/Kutu (Adet)</Label>
                <Input 
                  type="number" 
                  className="h-7 text-xs bg-black/20 border-white/10" 
                  placeholder="0.00"
